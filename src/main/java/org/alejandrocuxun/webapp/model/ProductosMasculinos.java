 ...
 * @author aleja
 */
public class ProductosMasculinos {
    ...
    public ProductosMasculinos() {
    }

    public ProductosMasculinos(int productoMasculinoId, String nombreProducto, double precioCompra, String descripcionProducto, int cantidadStock, double precioVentaUnitario, Blob imagenProducto, int distribuidorId, int categoriaproductoId) {
    ...
    public ProductosMasculinos(String nombreProducto, double precioCompra, String descripcionProducto, int cantidadStock, double precioVentaUnitario, Blob imagenProducto, int distribuidorId, int categoriaproductoId) {
        this.nombreProducto = nombreProducto;
        this.precioCompra = precioCompra;
        this.descripcionProducto = descripcionProducto;
        this.cantidadStock = cantidadStock;
