              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./inicio-ciudades.jsp">Ciudades</a>
                    </li>
                    <li class="nav-item">
        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../assets/image/InicioCiudad1.png" class="d-block w-100" alt="Ciudad1">
                </div>
            <div class="carousel-item">
                <img src="../../assets/image/InicioCiudad2.png" class="d-block w-100" alt="Ciudad2">
