    ...
    <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../assets/image/InicioProductosFemeninos1.png" class="d-block w-100" alt="Ciudad1">
                </div>
            <div class="carousel-item">
                <img src="../assets/image/InicioProductosFemeninos2.png" class="d-block w-100" alt="Ciudad2">
