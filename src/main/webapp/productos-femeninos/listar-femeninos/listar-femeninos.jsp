        ...
        <div class="container-fluid">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="producto-femeninos.jsp">Producto Femeninos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="formulario-femeninos/formulario-femeninos.jsp">Formulario Femeninos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../../femeninos-servlet">Lista Femeninos</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark">
                        ...
                        <li><a class="dropdown-item" href="../producto-masculinos/producto-masculinos.jsp">Productos Masculinos</a></li>
                        <li>
