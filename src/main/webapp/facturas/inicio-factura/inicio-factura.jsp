    ...
    <body>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./inicio-factura.jsp">Facturas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../formulario-factura/formulario-factura.jsp">formulario Facturas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../listar-factura/listar-factura.jsp">listar Facturas</a>
                    </li>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../assets/image/InicioFactura1.png" class="d-block w-100" alt="Ciudad1">
            <div class="carousel-caption d-none d-md-block">
              </div>
          </div>
          <div class="carousel-item">
            <img src="../../assets/image/InicioFactura2.png" class="d-block w-100" alt="Ciudad2">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        </div>
