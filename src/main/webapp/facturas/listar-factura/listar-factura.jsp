<%-- 
    ...
    Created on : 16/07/2024, 16:50:11
    Author     : kevin
--%>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../formulario-facura/formulario-factura.jsp">formulario Facturas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./listar-factura.jsp">listar Facturas</a>
                    </li>
