...
<%@page import="org.kevingutierrez.webapp.model.Factura"%>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="facturas/formulario-factura/formulario-factura.jsp">Formulario Facturas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="./factura-servlet">Lista Facturas</a>
                    </li>
            ...
            <table class="table" border="2px">
                ...
                <tbody>
                    ...
                    <% 
                        ...
                        <tr>
                            <th class="text-center text-bg-dark text-danger" scope="row"><%=factura.getFacturaId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=factura.getFecha()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=factura.getHora()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=factura.getClienteId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=factura.getTotal()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=factura.getProductoFemeninoId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=factura.getProductoMasculinoId()%></th>
                        </tr>
                        <% }
                    %>
                </tbody>
