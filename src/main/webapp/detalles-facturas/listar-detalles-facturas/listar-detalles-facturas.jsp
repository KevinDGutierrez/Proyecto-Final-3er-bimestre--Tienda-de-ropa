...
<%@page import="org.ianalfaro.webapp.model.DetalleFactura"%>
...
<html>
    <head>
        ...
        <title>Lista Detalle Factura</title>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="detalles-facturas/inicio-detalles-facturas/detalles-facturas.jsp">Detalles Facturas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="detalles-facturas/formulario-detalles-facturas/formulario-detalles-facturas.jsp">Formulario Detalles Facturas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="./detalle-factura-servlet">Lista Detalles Facturas</a>
                        </li>
            ...
            <table class="table" border="2px">
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-bg-dark text-danger" scope="col">Factura</th>
                ...
                <tbody>
                    <% List<DetalleFactura> detalleFacturas = (List)request.getAttribute("detalleFacturas"); %>
                    <% 
                        for(DetalleFactura detalleFactura:detalleFacturas){ %>
                        <tr>
                            <th class="text-center text-bg-dark text-danger" scope="row"><%=detalleFactura.getDetalleFacturaId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detalleFactura.getFacturaId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detalleFactura.getProductoFemeninoId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detalleFactura.getProductoMasculinoId()%></th>
                        </tr>
                        <% }
                    %>
                </tbody>
