              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="detalles-pedidos.jsp">Detalles Pedidos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../formulario-detalles-pedidos/formulario-detalles-pedidos.jsp">Formulario Detalles Pedidos</a>
                        </li>
                        <li class="nav-item">
