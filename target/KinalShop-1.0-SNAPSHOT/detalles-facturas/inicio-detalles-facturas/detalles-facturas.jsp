              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="detalles-facturas.jsp">Detalles Facturas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../formulario-detalles-facturas/formulario-detalles-facturas.jsp">Formulario Detalles Facturas</a>
                        </li>
                        <li class="nav-item">
