...
<html>
    <head>
        ...
        <title>Formulario Detalle Factura</title>
    ...
    <body>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../inicio-detalles-facturas/detalles-facturas.jsp">Detalles Facturas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="formulario-detalles-facturas.jsp">Formulario Detalles Facturas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../detalle-factura-servlet">Lista Detalles Facturas</a>
                        </li>
        ...
        <div>
            <% ArrayList<String> detalleFactura = (ArrayList)request.getAttribute("detalleFactura"); %>
            ...
            <%  if(detalleFactura != null){
                    for(String detFac:detalleFactura){%>
                        <ul class="list-group container mb-3 w-50">
                            <li class="list-group-item list-group-item-warning text-center"><%=detFac%></li>
                        </ul>
                    <%}
                }
            %>
        ...
        <div class="container mt-5 w-75">
            <form action="/KinalShop/detalle-factura-servlet" method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                <div class="form-floating mb-4">
                    <input type="number" class="form-control" id="facturaId" name="facturaId" placeholder="">
                    <label for="facturaId">Ingresar el Id de la Factura</label>
                </div>
                <div class="form-floating mb-4">
                ...
                <a href="../../facturas/formulario-factura/formulario-factura.jsp"><button class="btn btn-danger" type="button">Regresar al formulario Facturas</button></a>
            </form>
        </div>
    ...
    <script>
        function validarFormulario() {
            ...
            if (!facturaId || !productoFemeninoId || !productoMasculinoId) {
                alert('Algunos campos aún no están llenos, favor de verificar.');
                return false;
            }

            if (isNaN(facturaId) || isNaN(productoFemeninoId) || isNaN(productoMasculinoId)) {
