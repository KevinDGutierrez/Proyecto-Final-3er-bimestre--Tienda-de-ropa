...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="../productos-femeninos.jsp">Producto Femeninos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="agregar-femeninos.jsp">Formulario Femeninos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="../../femenino-servlet">Lista Femeninos</a>
                        </li>
                    </ul>
                </div>
                </div>
        ...
        <div class="container-floating mt-5 w-75">
            <form action="/KinalShop/femenino-servlet" method="post" enctype="multipart/form-data" onsubmit="validarFormularioFemenino(event)">
                ...
                <div class="form-floating mb-4">
                    ...
                    <label for="categoriaProductoId">ID de la Categoria del Producto</label>
                </div>
                <div>
        ...
        <script>
            function validarFormularioFemenino(event) {
