        ...
        <div class="container-fluid">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="producto-masculinos.jsp">Producto Masculinos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="formulario-masculinos/formulario-masculinos.jsp">Formulario Masculinos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../../masculinos-servlet">Lista Masculinos</a>
                </li>
