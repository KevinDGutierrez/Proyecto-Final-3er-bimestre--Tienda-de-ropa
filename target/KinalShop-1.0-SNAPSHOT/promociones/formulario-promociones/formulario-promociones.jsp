              ...
              <div class="offcanvas offcanvas-end text-bg-warning" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./formulario-promociones.jsp">formulario Promociones</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../listar-promociones/listar-promociones.jsp">listar Promociones</a>
                    </li>
