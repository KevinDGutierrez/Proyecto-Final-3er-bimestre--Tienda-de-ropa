...
<%@page import="org.alejandrocuxun.webapp.model.CategoriaProductos"%>
    ...
    <body>
        ...
        <div class="container mt-5">
            <table class="table" border="2px">
                ...
                <tbody>
                    <% List<CategoriaProductos> categoriaProductos = (List)request.getAttribute("categoriaProductos"); %>
                    <% 
                        for(CategoriaProductos categoriaProducto:categoriaProductos){ %>
                            <tr>
                                <th class="text-center text-bg-dark text-danger" scope="row"><%=categoriaProducto.getCategoriaProductosId()%></th>
                                <td class="text-center text-bg-secondary text-light" scope="row"><%=categoriaProducto.getNombreCategoria()%></td>
                                <td class="text-center text-bg-secondary text-light" scope="row"><%=categoriaProducto.getDescripcionCategoria()%></td>
                            </tr>
                        <% }
                    %>
                </tbody>
