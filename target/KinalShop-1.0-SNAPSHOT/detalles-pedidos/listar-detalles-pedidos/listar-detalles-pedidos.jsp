...
<%@page import="org.ianalfaro.webapp.model.DetallePedido"%>
...
<html>
    <head>
        ...
        <title>Lista Detalle Pedido</title>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="detalles-pedidos/inicio-detalles-pedidos/detalles-pedidos.jsp">Detalles Pedidos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="detalles-pedidos/formulario-detalles-pedidos/formulario-detalles-pedidos.jsp">Formulario Detalles Pedidos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="./detalle-pedido-servlet">Lista Detalles Pedidos</a>
                        </li>
            ...
            <table class="table" border="2px">
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-bg-dark text-danger" scope="col">Cantidad Comprada</th>
                        <th class="text-center text-bg-dark text-danger" scope="col">Productos Masculinos</th>
                        <th class="text-center text-bg-dark text-danger" scope="col">Productos Femeninos</th>
                        <th class="text-center text-bg-dark text-danger" scope="col">Pedido</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <% 
                        ...
                        <tr>
                            <th class="text-center text-bg-dark text-danger" scope="row"><%=detallePedido.getDetallePedidoId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detallePedido.getCantidadComprada()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detallePedido.getProductoMasculinoId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detallePedido.getProductoFemeninoId()%></th>
                            <th class="text-center text-bg-secondary text-light" scope="row"><%=detallePedido.getPedidoId()%></th>
                        </tr>
                        <% }
                    %>
                </tbody>
