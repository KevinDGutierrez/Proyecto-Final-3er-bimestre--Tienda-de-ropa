...
<html>
    ...
    <body>
              ...
              <div class="offcanvas offcanvas-end text-bg-info" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../inicio-detalles-pedidos/detalles-pedidos.jsp">Detalles Pedidos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="formulario-detalles-pedidos.jsp">Formulario Detalles Pedidos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../../detalle-pedido-servlet">Lista Detalles Pedidos</a>
                        </li>
        ...
        <div>
            <% ArrayList<String> detallePedido = (ArrayList)request.getAttribute("detallePedido"); %>
            ...
            <%  if(detallePedido != null){
                    for(String detPed:detallePedido){%>
                        <ul class="list-group container mb-3 w-50">
                            <li class="list-group-item list-group-item-warning text-center"><%=detPed%></li>
                        </ul>
                    <%}
                }
            %>
        ...
        <div class="container mt-5 w-75">
            <form action="/KinalShop/detalle-pedido-servlet" method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                <div class="form-floating mb-4">
                    <input type="number" class="form-control" id="cantidadComprada" name="cantidadComprada" placeholder="">
                    <label for="cantidadComprada">Ingresar la cantidad comprada</label>
                </div>
                <div class="form-floating mb-4">
                ...
                <div class="form-floating mb-4">
                    <input type="number" class="form-control" id="pedidoId" name="pedidoId" placeholder="">
                    <label for="pedidoId">Ingresar el Id del Pedido</label>
                </div>
                <div>
                    <input class="btn btn-success position-relative" type="submit" value="Agregar">
                </div>
                <a href="../../pedidos/formulario-pedidos/formulario-pedidos.jsp"><button class="btn btn-danger" type="button">Regresar al formulario Pedidos</button></a>
            </form>
        </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <script>
        function validarFormulario() {
            const cantidadComprada = document.getElementById('cantidadComprada').value.trim();
            ...
            if (!cantidadComprada || !productoFemeninoId || !productoMasculinoId || !pedidoId) {
                alert('Algunos campos aún no están llenos, favor de verificar.');
                return false;
            }

            if (isNaN(cantidadComprada) || isNaN(productoFemeninoId) || isNaN(productoMasculinoId) || isNaN(pedidoId)) {
