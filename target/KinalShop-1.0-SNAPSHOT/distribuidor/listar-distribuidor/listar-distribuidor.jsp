        ...
        <div class="container-fluid">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="distribuidor.jsp">Distribuidores</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="formulario-distribuidor/formulario-distribuidor.jsp">Formulario Distribuidores</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../../distribuidor-servlet">Lista Distribuidores</a>
                </li>
