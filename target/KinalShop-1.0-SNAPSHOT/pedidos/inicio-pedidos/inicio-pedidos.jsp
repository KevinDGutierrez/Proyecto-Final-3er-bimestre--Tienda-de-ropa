<%-- 
    Document   : inicio-pedidos
    Created on : 16/07/2024, 17:45:13
    Author     : kevin
--%>
    ...
    <body>
              ...
              <div class="offcanvas offcanvas-end text-bg-danger" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./inicio-pedidos.jsp">Pedidos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../formulario-pedidos/formulario-pedidos.jsp">formulario Pedidos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../listar-pedidos/listar-pedidos.jsp">listar Pedidos</a>
                    </li>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../assets/image/InicioPedido1.png" class="d-block w-100" alt="Ciudad1">
            <div class="carousel-caption d-none d-md-block">
              </div>
          </div>
          <div class="carousel-item">
            <img src="../../assets/image/InicioPedido2.png" class="d-block w-100" alt="Ciudad2">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        </div>
